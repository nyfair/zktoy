...
use bellman::plonk::better_cs::adaptor::{TranspilationVariant, Transpiler};
use bellman::plonk::better_cs::cs::{
    ConstraintSystem as PlonkConstraintSystem, PlonkConstraintSystemParams, PlonkCsWidth4WithNextStepParams,
};
use bellman::plonk::cs::gates::Variable as PlonkVariable;
...
impl<E: Engine, P: PlonkConstraintSystemParams<E>> bellman::ConstraintSystem<E> for TranspilerWrapper<E, P> {
    type Root = Self;
    ...
    fn alloc<F, A, AR>(&mut self, a: A, f: F) -> Result<bellman::Variable, bellman::SynthesisError>
    where
        F: FnOnce() -> Result<E::Fr, bellman::SynthesisError>,
        A: FnOnce() -> AR,
        AR: Into<String>,
    {
        <Transpiler<E, P> as bellman::ConstraintSystem<E>>::alloc(&mut self.inner, a, f)
    }
    fn alloc_input<F, A, AR>(&mut self, a: A, f: F) -> Result<bellman::Variable, bellman::SynthesisError>
    where
        F: FnOnce() -> Result<E::Fr, bellman::SynthesisError>,
        A: FnOnce() -> AR,
        AR: Into<String>,
    {
        <Transpiler<E, P> as bellman::ConstraintSystem<E>>::alloc_input(&mut self.inner, a, f)
    }
...
pub fn transpile_with_gates_count<E: Engine, C: bellman::Circuit<E>>(
    circuit: C,
